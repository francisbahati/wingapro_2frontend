...
class BusinessStaffProfileScreen extends StatefulWidget {
  const BusinessStaffProfileScreen({super.key});

  @override
  State<BusinessStaffProfileScreen> createState() =>
      _BusinessStaffProfileScreenState();
}

class _BusinessStaffProfileScreenState
    extends State<BusinessStaffProfileScreen> {
  ...
  Future<void> _changePassword(
    ...
    try {
      ...
      final response = await _api.post(
        context,
        '${ApiConfig.baseUrl}/api/business-staff/change-password',
