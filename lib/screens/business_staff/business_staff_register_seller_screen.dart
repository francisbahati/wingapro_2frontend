...
class BusinessStaffRegisterSellerScreen extends StatefulWidget {
  const BusinessStaffRegisterSellerScreen({super.key});

  @override
  State<BusinessStaffRegisterSellerScreen> createState() =>
      _BusinessStaffRegisterSellerScreenState();
}

class _BusinessStaffRegisterSellerScreenState
    extends State<BusinessStaffRegisterSellerScreen> {
  ...
  Future<void> _registerSeller() async {
    ...
    try {
      ...
      final response = await _api.post(
        context,
        '${ApiConfig.baseUrl}/api/business-staff/register-seller',
        body: {
          'username': username,
          'email': email,
            ...
            GlassCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Create a seller account. The seller will need admin approval to start selling.',
                    style: TextStyle(
