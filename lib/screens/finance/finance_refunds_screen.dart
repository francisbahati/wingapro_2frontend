...
class FinanceRefundsScreen extends StatefulWidget {
  final bool showAppBar;
  const FinanceRefundsScreen({super.key, this.showAppBar = true});

  @override
  State<FinanceRefundsScreen> createState() => _FinanceRefundsScreenState();
}

class _FinanceRefundsScreenState extends State<FinanceRefundsScreen> {
  ...
  Future<void> _fetchRefunds() async {
    ...
    try {
      ...
      final response = await _api.get(
        context,
        '${ApiConfig.baseUrl}/api/finance/refunds',
      );
  ...
  Future<void> _updateRefund(int id, String status, String reply) async {
    ...
    try {
      ...
      final response = await _api.put(
        context,
        '${ApiConfig.baseUrl}/api/finance/refunds/$id',
