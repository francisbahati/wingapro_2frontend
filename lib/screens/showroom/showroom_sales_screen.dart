// lib/screens/showroom/showroom_sales_screen.dart
import 'dart:async';
import 'dart:convert';
...
class ShowroomSalesScreen extends StatefulWidget {
  final bool showAppBar;
  const ShowroomSalesScreen({super.key, this.showAppBar = true});

  @override
  State<ShowroomSalesScreen> createState() => _ShowroomSalesScreenState();
}

class _ShowroomSalesScreenState extends State<ShowroomSalesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget body = _isLoading
      ...
      isFullScreen: false,
        ...
        : _sales.isEmpty
        ? const Center(child: Text('No sales made yet.'))
        : RefreshIndicator(
