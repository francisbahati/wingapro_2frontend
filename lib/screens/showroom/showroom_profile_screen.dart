// lib/screens/showroom/showroom_profile_screen.dart
import 'dart:convert';
...
class ShowroomProfileScreen extends StatefulWidget {
  ...
  const ShowroomProfileScreen({super.key, this.showAppBar = true});
  ...
  Future<void> _changePassword(
    ...
    try {
      ...
      final response = await _api.post(
        context,
        '${ApiConfig.baseUrl}/api/showroom/change-password',
