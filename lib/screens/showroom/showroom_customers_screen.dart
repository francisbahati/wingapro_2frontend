// lib/screens/showroom/showroom_customers_screen.dart
import 'dart:async';
import 'dart:convert';
...
class ShowroomCustomersScreen extends StatefulWidget {
  final bool showAppBar;
  const ShowroomCustomersScreen({super.key, this.showAppBar = true});

  @override
  State<ShowroomCustomersScreen> createState() =>
      _ShowroomCustomersScreenState();
}

class _ShowroomCustomersScreenState extends State<ShowroomCustomersScreen> {
              ...
              onPressed: isSubmitting
                ...
                try {
                  ...
                  final response = await _api.put(
                    ctx,
                    '${ApiConfig.baseUrl}/api/showroom/customers/${customer['id']}',
                    body: {
                      'username': username,
                      'email': email,
                      'phone': phone,
  ...
  Future<void> _deleteCustomer(int id) async {
    ...
    try {
      ...
      final response = await _api.delete(
        context,
        '${ApiConfig.baseUrl}/api/showroom/customers/$id',
      );
      if (response.statusCode == 200) {
        _fetchCustomers();
        if (mounted) {
          ...
          return GlassCard(
            ...
            child: ListTile(
              leading: CircleAvatar(
                backgroundColor:
                c['is_active'] ? Colors.green : Colors.red,
                child: Text(
